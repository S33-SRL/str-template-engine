...
import { StrTemplateEngine } from 'projects/str-template-engine/src/public-api';
...
export class AppComponent {
  ...
  title = 'ngx-str-template-engine-example';
  tmpEngine: StrTemplateEngine | null = null;

  constructor(private currencyPipe:CurrencyPipe){
    this.tmpEngine = new StrTemplateEngine(currencyPipe);
  }
  ...
  tmpCalc(teampalte:string){
    return this.tmpEngine?.parse(teampalte,this.objExample)
  }
